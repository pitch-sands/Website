...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>website</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class WebsiteExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.website"));
				Website root = WebsiteFactory.eINSTANCE.createWebsite();
