...
public class AddBoardFeature extends AbstractAddShapeFeature {
	...
	public AddBoardFeature(IFeatureProvider fp) {
		super(fp);
	}
	...
	public PictogramElement add(IAddContext context) {
		...
		for (Square square : board.getSquares()) {
			...
			squareRectangle.setForeground(manageColor(IColorConstant.DARK_BLUE));
