...
public class DirectEditingButtonBoxFeature extends
	AbstractDirectEditingFeature {
	 
	public DirectEditingButtonBoxFeature(IFeatureProvider fp) {
	        super(fp);
	    }
    ...
    public boolean canDirectEdit(IDirectEditingContext context) {
        ...
        if (bo instanceof ButtonBox && ga instanceof Text) {
            return true;
        }
	...
	public String getInitialValue(IDirectEditingContext context) {
        ...
        PictogramElement pe = context.getPictogramElement();
        ButtonBox eClass = (ButtonBox) getBusinessObjectForPictogramElement(pe);
