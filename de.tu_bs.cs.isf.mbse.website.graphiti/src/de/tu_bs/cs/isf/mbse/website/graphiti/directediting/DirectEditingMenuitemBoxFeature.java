...
public class DirectEditingMenuitemBoxFeature extends
	AbstractDirectEditingFeature {
	 
	public DirectEditingMenuitemBoxFeature(IFeatureProvider fp) {
	        super(fp);
	    }
    ...
    public boolean canDirectEdit(IDirectEditingContext context) {
        ...
        if (bo instanceof MenuitemBox && ga instanceof Text) {
            return true;
        }
	...
	public String getInitialValue(IDirectEditingContext context) {
        ...
        PictogramElement pe = context.getPictogramElement();
        MenuitemBox eClass = (MenuitemBox) getBusinessObjectForPictogramElement(pe);
    ...
    public String checkValueValid(String value, IDirectEditingContext context) {
        if (value.length() < 1)
            return "Please enter any text as button name.";
       // if (value.contains(" "))
