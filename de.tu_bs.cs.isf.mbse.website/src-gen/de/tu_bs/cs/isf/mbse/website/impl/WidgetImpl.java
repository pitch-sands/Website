 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.website.impl.WidgetImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.mbse.website.impl.WidgetImpl#getRow <em>Row</em>}</li>
...
public class WidgetImpl extends EObjectImpl implements Widget {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.WIDGET;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WIDGET__NAME, oldName, name));
	}
	...
	public void setRow(int newRow) {
		...
		row = newRow;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WIDGET__ROW, oldRow, row));
	}
	...
	public void setWidth(double newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WIDGET__WIDTH, oldWidth, width));
	}
	...
	public void setHeight(double newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WIDGET__HEIGHT, oldHeight, height));
	}
	...
	public void setColumn(int newColumn) {
		...
		column = newColumn;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WIDGET__COLUMN, oldColumn, column));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WebsitePackage.WIDGET__NAME:
				return getName();
			case WebsitePackage.WIDGET__ROW:
				return getRow();
			case WebsitePackage.WIDGET__WIDTH:
				return getWidth();
			case WebsitePackage.WIDGET__HEIGHT:
				return getHeight();
