 ...
 * </p>
 * <ul>
 *   <li>{@link de.tu_bs.cs.isf.mbse.website.impl.WebsiteImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.tu_bs.cs.isf.mbse.website.impl.WebsiteImpl#getWidgets <em>Widgets</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WebsiteImpl extends MinimalEObjectImpl.Container implements Website {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.WEBSITE__NAME, oldName, name));
	}
	...
	public EList<Widget> getWidgets() {
		if (widgets == null) {
			widgets = new EObjectContainmentEList<Widget>(Widget.class, this, WebsitePackage.WEBSITE__WIDGETS);
		}
		return widgets;
	}
